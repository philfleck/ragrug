...
namespace Svg{
	...
	public class RenderContext{
		...
		internal void Draw(){
            ...
            // Draw now!
            //var tx = Filter.Draw(DrawInfo);
            //var tx2d = Loonim.SurfaceTexture.ToTexture2D(tx, false);
            //var b = tx2d.EncodeToPNG();
            //System.IO.File.WriteAllBytes(Application.persistentDataPath + "\\test.png", b);
		}
