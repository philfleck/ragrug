...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManagerEditor : Editor
    {
        ...
        SerializedProperty serializedDebugMessageText;
        SerializedProperty serializedSceneUnderstandingEnabled;
        SerializedProperty serializedAutomaticRegistration;
        SerializedProperty serializedAutoRefreshInitialIntervalInSeconds;
        ...
        SerializedProperty serializedRequestQuads;
        SerializedProperty serializedRequestMeshes;
        SerializedProperty serializedRequestWorldMesh;
        ...
        private void OnEnable()
        {
            ...
            serializedDebugMessageText = serializedObject.FindProperty("DebugMessageText");
            serializedSceneUnderstandingEnabled = serializedObject.FindProperty("PlaneDetectionEnabled");
            serializedAutomaticRegistration = serializedObject.FindProperty("AutomaticRegistration");
            serializedAutoRefreshInitialIntervalInSeconds = serializedObject.FindProperty("InitialAutoRefreshIntervalInSeconds");
            ...
            serializedRequestQuads = serializedObject.FindProperty("RequestQuads");
            serializedRequestMeshes = serializedObject.FindProperty("RequestMeshes");
            serializedRequestWorldMesh = serializedObject.FindProperty("RequestWorldMesh");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedDebugMessageText);
            EditorGUILayout.PropertyField(serializedSceneUnderstandingEnabled);
            EditorGUILayout.PropertyField(serializedAutomaticRegistration);
            EditorGUILayout.PropertyField(serializedAutoRefreshInitialIntervalInSeconds);
            ...
            if (SUManager.QuerySceneFromDevice)
            {
                ...
                serializedBoudingSphereRadiousInMeters.floatValue = EditorGUILayout.Slider(BoundingSphereRadiousInMetersContent, serializedBoudingSphereRadiousInMeters.floatValue, 1.0f, 10.0f);
            ...
            EditorGUILayout.PropertyField(serializedRequestQuads);
            EditorGUILayout.PropertyField(serializedRequestMeshes);
            EditorGUILayout.PropertyField(serializedRequestWorldMesh);
            GUILayout.Space(verticalSpaceBetweenHeaders);
