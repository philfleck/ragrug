    ...
    public class Replicator : MonoBehaviour
    {
...
#else
                                                        var parsed = Json.JSON.Parse(content);
#endif
                                                        var val = parsed[dKey];
        ...
        public static void SyncVis(Visualisation vis)
        {
            try
            {
                ...
                if (dirtyX = vis.theVisualizationObject.creationConfiguration.Axies.ContainsKey(CreationConfiguration.Axis.X))
                {
                ...
                if (dirtyY = vis.theVisualizationObject.creationConfiguration.Axies.ContainsKey(CreationConfiguration.Axis.Y))
                {
                ...
                if (dirtyZ = vis.theVisualizationObject.creationConfiguration.Axies.ContainsKey(CreationConfiguration.Axis.Z))
                {
            ...
            if (vis.theVisualizationObject.creationConfiguration.ReplicationNotification != null) {
            ...
            {
                Debug.Log("SyncVis ERROR vis.updateView(0); FAILED => " + err);
            }
