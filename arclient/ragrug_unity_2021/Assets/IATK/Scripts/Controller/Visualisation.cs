...
namespace IATK
{
    ...
    public class Visualisation : MonoBehaviour
    {
        ...
        {
            Debug.Log("VEX => CreateVisualisation ");
            try
            {
                ...
                Debug.Log("IATK::Visualization::CreateVisualization before => RuntimeEditorLoadAndSaveConfiguration");
                RuntimeEditorLoadAndSaveConfiguration();

                Debug.Log("IATK::Visualization::CreateVisualization before => key");
                key = (GameObject)Instantiate(Resources.Load("Key"));
                key.transform.parent = transform;
                key.transform.localPosition = new Vector3(0.15f, 1.165f, 0f);
            } catch(Exception e)
            {
                Debug.Log("IATK::Visualization::CreateVisualization ERROR => " + e);
            }
        }
        ...
        public void updateView(AbstractVisualisation.PropertyType propertyType)
        {
            ...
            {
                Debug.Log("IATK::Visualization::updateView ERROR => " + e);
            }
        }
        ...
        public void updateViewProperties(AbstractVisualisation.PropertyType propertyType)
        {
            ...
            {
                Debug.Log("IATK::Visualization::updateViewProperties ERROR => " + e);
            }
        }
        ...
        {
            Debug.Log("VEX => setLinkingIndices ");
        ...
        private void updateKey()
        {
            ...
            {
                Debug.Log("IATK::Visualization::updateKey ERROR => " + e);
            }
        }
