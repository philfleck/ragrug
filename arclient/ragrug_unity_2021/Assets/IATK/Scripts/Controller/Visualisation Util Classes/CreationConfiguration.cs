...
namespace IATK
{
    ...
    public class SerializableCreationConfiguration
    {
        ...
        public void DeSerializeJson(string json, CreationConfiguration cf)
        {
            ...
            cf.ColourDimension = scc.ColourDimension ?? "Undefined";
            cf.SizeDimension = scc.SizeDimension ?? "Undefined";
    ...
    public class CreationConfiguration
    {
        ...
        public string ColourDimension { get; set; } = "Undefined";                     // Colour mapped to a dimension
        public string SizeDimension { get; set; } = "Undefined";                       // Size mapped to a dimension
